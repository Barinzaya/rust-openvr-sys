...
pub const IVRCompositor_Version: &[u8; 18] = b"IVRCompositor_027\0";
...
pub const IVROverlay_Version: &[u8; 15] = b"IVROverlay_026\0";
...
pub const k_pch_SteamVR_RenderCameraMode: &[u8; 17] = b"renderCameraMode\0";
...
pub const ETrackedDeviceProperty_Prop_SupportsRoomViewDirect_Bool: ETrackedDeviceProperty = 2105;
pub const ETrackedDeviceProperty_Prop_SupportsAppThrottling_Bool: ETrackedDeviceProperty = 2106;
...
fn bindgen_test_layout_VR_IVROverlay_FnTable() {
    ...
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).GetOverlayTransformOverlayRelative) as usize - ptr as usize
        },
        304usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).SetOverlayTransformOverlayRelative) as usize - ptr as usize
        },
        312usize,
        concat!(
            "Offset of field: ",
